...
(EN) A Java application built using Drools, a business rules management system (BRMS). The application uses a rules system to calculate promotions at a pizzeria and their various combinations.
